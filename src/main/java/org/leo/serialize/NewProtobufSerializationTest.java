...
import org.leo.serialize.protobuf.domain.NewAddressBookProtos.Person;
import org.leo.serialize.protobuf.domain.NewAddressBookProtos.PhoneNumber;
import org.leo.serialize.protobuf.domain.NewAddressBookProtos.PhoneType;


public class NewProtobufSerializationTest {

	public AddressBook getAddressBook() {				
		
		PhoneNumber.Builder pn1 = PhoneNumber.newBuilder();
		pn1.setNumber("100000000000001");
		pn1.setType(PhoneType.HOME);
		PhoneNumber.Builder pn2 = PhoneNumber.newBuilder();
	...
	public void testProtobufPerm() throws Exception {
		...
		System.out.println("newProtobuf\twrite and parse 500 times in "
